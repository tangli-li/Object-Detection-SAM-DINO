...
def get_args_parser():
    ...
    # training parameters
    parser.add_argument('--output_dir', default='D:\\NTU\\FYP\\DINO+inference\\DINO-main\\inference_image\\output_stable',
    ...
    parser.add_argument('--resume', default='D:\\NTU\\FYP\\DINO+inference\\DINO-main\\checkpoint_stable\\checkpoint0047.pth', help='resume from checkpoint')
...
path="D:\\NTU\\FYP\\NA-VID_val\\val\\val\\annotations\\annotation.json"
...
def filter_boxes(scores, boxes, confidence=0.25, apply_nms=True, iou=0.5):
    # 筛选出真正的置信度高的框
...
def main(args,compare=1):
    ...
    image_file_path = os.listdir("D:\\NTU\\FYP\\DINO+inference\\DINO-main\\inference_image\\original image")
    image_set = []

    for image_item in image_file_path:
        print("inference_image:", image_item)
        image_path = os.path.join("D:\\NTU\\FYP\\DINO+inference\\DINO-main\\inference_image\\original image", image_item)
        ...
        if compare==1:
            ...
            output_path="D:\\NTU\FYP\\DINO+inference\\DINO-main\\inference_image\\real_image"
