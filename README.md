...
The training and testing data come from [HA-VID](https://iai-hrc.github.io/ha-vid), an assembly dataset for industrial scenarios. All model training, inference, and testing are performed on the NVIDIA RTX 3060.
